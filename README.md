...
- ヘッダーの背景色を、入荷画面と入荷先に関する画面は赤、出荷画面と出荷先に関する画面は青など、項目ごとに変化させることでどの項目の操作をしているかを視覚的に把握しやすくなるようにいたしました。
- スマートフォン・タブレット・パソコンでの運用を想定しているため、レスポンシブにすることでデバイスのサイズにかかわらず画面が見やすく、操作しやすいようにいたしました。
